...
def start(update, context):
    ...
    buttons.buildbutton("Facebook", "https://www.facebook.com/samadrita.mukhopadhyay.7")
    buttons.buildbutton("Instagram", "https://www.instagram.com/samadrita_mukhopadhyay")
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='Samadrita Mirrorbot Help',
        author_name='Samadrita Mukhopadhyay',
        author_url='https://t.me/samadrita2003',
